...
/**
 * @ast node
 * @declaredat extendj/java5/grammar/Generics.ast:3
...
public class GenericInterfaceDecl extends InterfaceDecl implements Cloneable, GenericTypeDecl {
   ...
   * @declaredat extendj/java5/frontend/PrettyPrint.jadd:113
   */
   ...
   * @declaredat extendj/java5/frontend/Generics.jrag:648
   */
   ...
   * @declaredat extendj/java5/frontend/Generics.jrag:1454
   */
   ...
   * @attribute inh
   * @aspect GenericsTypeCheck
   * @declaredat extendj/java5/frontend/Generics.jrag:657
   */
  @ASTNodeAnnotation.Attribute
  ...
  /**
   * @declaredat extendj/java5/frontend/Generics.jrag:714
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java5/frontend/Generics.jrag:715
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java5/frontend/GenericsParTypeDecl.jrag:74
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TypeVariablePositions.jrag:46
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TypeVariablePositions.jrag:47
   * @apilevel internal
   */
