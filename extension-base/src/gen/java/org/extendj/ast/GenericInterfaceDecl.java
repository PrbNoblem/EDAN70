...
/**
 * @ast node
 * @declaredat /home/felix/EDAN70/extension-base/extendj/java5/grammar/Generics.ast:4
...
public class GenericInterfaceDecl extends InterfaceDecl implements Cloneable, GenericTypeDecl {
   ...
   * @declaredat /home/felix/EDAN70/extension-base/extendj/java5/frontend/PrettyPrint.jadd:247
   */
...
protected ASTNode$State.Cycle usesTypeVariable_cycle = null;
   ...
   * @declaredat /home/felix/EDAN70/extension-base/extendj/java5/frontend/Generics.jrag:651
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="GenericsTypeCheck", declaredAt="/home/felix/EDAN70/extension-base/extendj/java5/frontend/Generics.jrag:651")
  ...
  public SimpleSet<TypeDecl> Define_lookupType(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (_callerNode == getBodyDeclListNoTransform()) {
      ...
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java5/frontend/Generics.jrag:718
      int childIndex = _callerNode.getIndexOfChild(_childNode);
      {
  ...
  public int Define_typeVarPosition(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getTypeParameterListNoTransform()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java8/frontend/TypeVariablePositions.jrag:46
  ...
  public boolean Define_typeVarInMethod(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getTypeParameterListNoTransform()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java8/frontend/TypeVariablePositions.jrag:47
      int childIndex = _callerNode.getIndexOfChild(_childNode);
      return false;
    }
    else {
  ...
  protected void collect_contributors_CompilationUnit_problems(CompilationUnit _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /home/felix/EDAN70/extension-base/extendj/java5/frontend/Generics.jrag:644
