...
/**
 * @ast node
 * @declaredat extendj/java4/grammar/Java.ast:79
...
public class VarDeclStmt extends Stmt implements Cloneable {
   ...
   * @declaredat extendj/java4/frontend/PrettyPrint.jadd:165
   */
  ...
  /**
   * @aspect ErrorCheck
   * @declaredat extendj/java4/frontend/ErrorCheck.jrag:250
   */
   ...
   * @declaredat extendj/java4/frontend/LookupVariable.jrag:205
   */
  @ASTNodeAnnotation.Attribute
  ...
  /**
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:75
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:488
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:988
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/LookupVariable.jrag:112
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/SyntacticClassification.jrag:111
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/TypeAnalysis.jrag:284
   * @apilevel internal
   */
