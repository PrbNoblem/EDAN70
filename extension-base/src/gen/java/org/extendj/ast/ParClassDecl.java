...
/**
 * @ast node
 * @declaredat extendj/java5/grammar/Generics.ast:6
...
public class ParClassDecl extends ClassDecl implements Cloneable, ParTypeDecl, MemberSubstitutor {
   ...
   * @declaredat extendj/java5/frontend/PrettyPrint.jadd:35
   */
   ...
   * @declaredat extendj/java5/frontend/Generics.jrag:789
   */
   ...
   * @declaredat extendj/java5/frontend/Generics.jrag:959
   */
  ...
  /**
   * @aspect LookupParTypeDecl
   * @declaredat extendj/java5/frontend/Generics.jrag:990
   */
  ...
  /**
   * @aspect LookupParTypeDecl
   * @declaredat extendj/java5/frontend/Generics.jrag:994
   */
   ...
   * @declaredat extendj/java5/frontend/GenericsParTypeDecl.jrag:99
   */
  ...
  /**
   * @aspect LambdaExpr
   * @declaredat extendj/java8/frontend/LambdaExpr.jrag:111
   */
  ...
  public void setSuperClassOpt(Opt<Access> node) {
    throw new Error("Can not replace NTA child SuperClassOpt in ParClassDecl!");
  }
  /**
  ...
  public void setImplementsList(List<Access> node) {
    throw new Error("Can not replace NTA child ImplementsList in ParClassDecl!");
  }
  /**
   ...
   * @declaredat extendj/java5/frontend/GenericsSubtype.jrag:134
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat extendj/java5/frontend/ReifiableTypes.jrag:39
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat extendj/java8/frontend/GenericsSubtype.jrag:155
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat extendj/java5/frontend/Generics.jrag:591
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute syn
   * @aspect LookupParTypeDecl
   * @declaredat extendj/java5/frontend/Generics.jrag:816
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute syn
   * @aspect GenericsParTypeDecl
   * @declaredat extendj/java5/frontend/GenericsParTypeDecl.jrag:55
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect GenericsParTypeDecl
   * @declaredat extendj/java5/frontend/GenericsParTypeDecl.jrag:71
   */
  @ASTNodeAnnotation.Attribute
  ...
  /**
   * @declaredat extendj/java5/frontend/Generics.jrag:703
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java5/frontend/GenericsParTypeDecl.jrag:75
   * @apilevel internal
   */
