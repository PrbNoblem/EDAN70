...
/**
 * @ast node
 * @declaredat extendj/java4/grammar/Java.ast:139
...
public class LogNotExpr extends Unary implements Cloneable {
  /**
   * @aspect TypeCheck
   * @declaredat extendj/java4/frontend/TypeCheck.jrag:338
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:421
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:912
   * @apilevel internal
   */
