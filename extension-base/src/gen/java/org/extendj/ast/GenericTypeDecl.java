 ...
 * @ast interface
 * @aspect Generics
 * @declaredat extendj/java5/frontend/Generics.jrag:203
 */
...
public List createArgumentList(Collection<TypeDecl> args);
   ...
   * @attribute syn
   * @aspect Generics
   * @declaredat extendj/java5/frontend/Generics.jrag:204
   */
   ...
   * @attribute syn
   * @aspect Generics
   * @declaredat extendj/java5/frontend/Generics.jrag:209
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat extendj/java5/frontend/Generics.jrag:871
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute syn
   * @aspect LookupParTypeDecl
   * @declaredat extendj/java5/frontend/Generics.jrag:879
   */
  @ASTNodeAnnotation.Attribute
