 ...
 * @ast node
 * @declaredat extendj/java7/grammar/MultiCatch.ast:14
...
public class MultiCatch extends CatchClause implements Cloneable {
   ...
   * @declaredat extendj/java7/frontend/PrettyPrint.jadd:75
   */
   ...
   * @declaredat extendj/java7/frontend/PreciseRethrow.jrag:293
   */
   ...
   * @declaredat extendj/java4/frontend/ExceptionHandling.jrag:259
   */
  @ASTNodeAnnotation.Attribute
  ...
  /**
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:49
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:50
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:51
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:102
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:152
   * @apilevel internal
   */
