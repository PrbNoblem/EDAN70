...
/**
 * @ast node
 * @declaredat extendj/java5/grammar/Generics.ast:16
...
public class ParTypeAccess extends Access implements Cloneable {
   ...
   * @declaredat extendj/java5/frontend/PrettyPrint.jadd:102
   */
   ...
   * @declaredat extendj/java5/frontend/Generics.jrag:415
   */
   ...
   * @declaredat extendj/java5/frontend/Generics.jrag:668
   */
   ...
   * @declaredat extendj/java8/frontend/FunctionalInterface.jrag:223
   */
  ...
  /**
   * @declaredat extendj/java5/frontend/Generics.jrag:332
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java5/frontend/Generics.jrag:705
   * @apilevel internal
   */
