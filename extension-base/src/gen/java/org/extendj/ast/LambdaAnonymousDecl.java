...
/**
 * @ast node
 * @declaredat extendj/java8/grammar/LambdaAnonymousDecl.ast:1
...
public class LambdaAnonymousDecl extends AnonymousDecl implements Cloneable {
  ...
  public void setImplementsList(List<Access> node) {
    throw new Error("Can not replace NTA child ImplementsList in LambdaAnonymousDecl!");
  }
  /**
   ...
   * @declaredat extendj/java8/frontend/EnclosingLambda.jrag:37
   */
  @ASTNodeAnnotation.Attribute
