...
/**
 * @ast node
 * @declaredat extendj/java5/grammar/Generics.ast:7
...
public class RawClassDecl extends ParClassDecl implements Cloneable {
   ...
   * @declaredat extendj/java5/frontend/Generics.jrag:1062
   */
  ...
  /**
   * @aspect LookupParTypeDecl
   * @declaredat extendj/java5/frontend/Generics.jrag:1129
   */
  ...
  /**
   * @aspect LookupParTypeDecl
   * @declaredat extendj/java5/frontend/Generics.jrag:1157
   */
  ...
  public void setSuperClassOpt(Opt<Access> node) {
    throw new Error("Can not replace NTA child SuperClassOpt in RawClassDecl!");
  }
  /**
  ...
  public void setImplementsList(List<Access> node) {
    throw new Error("Can not replace NTA child ImplementsList in RawClassDecl!");
  }
  /**
  ...
  public void setArgumentList(List<Access> node) {
    throw new Error("Can not replace NTA child ArgumentList in RawClassDecl!");
  }
  /**
  ...
  public List getArgumentList() {
    ...
    getArgumentList_value = ((GenericClassDecl) genericDecl()).createArgumentList(Collections.<TypeDecl>emptyList());
    setChild(getArgumentList_value, getArgumentListChildPosition());
    if (true) {
