...
/**
 * @ast node
 * @declaredat extendj/java4/grammar/Java.ast:82
...
public class VariableDecl extends ASTNode<ASTNode> implements Cloneable {
   ...
   * @declaredat extendj/java4/frontend/PrettyPrint.jadd:58
   */
   ...
   * @declaredat extendj/java4/frontend/VariableDeclaration.jrag:173
   */
  ...
  /**
   * @aspect VariableDeclarationTransformation
   * @declaredat extendj/java4/frontend/VariableDeclaration.jrag:188
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:63
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:361
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:362
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:363
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:364
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:365
   * @apilevel internal
   */
