...
/**
 * @ast node
 * @declaredat extendj/java5/grammar/Annotations.ast:11
...
public class ElementConstantValue extends ElementValue implements Cloneable {
   ...
   * @declaredat extendj/java5/frontend/PrettyPrint.jadd:325
   */
  ...
  /**
   * @aspect Annotations
   * @declaredat extendj/java5/frontend/Annotations.jrag:214
   */
   ...
   * @attribute syn
   * @aspect Annotations
   * @declaredat extendj/java5/frontend/Annotations.jrag:558
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect Annotations
   * @declaredat extendj/java5/frontend/Annotations.jrag:224
   */
  @ASTNodeAnnotation.Attribute
  ...
  /**
   * @declaredat extendj/java5/frontend/Annotations.jrag:647
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java5/frontend/Annotations.jrag:652
   * @apilevel internal
   */
