...
/**
 * @ast node
 * @declaredat extendj/java4/grammar/Java.ast:27
...
public class SuperAccess extends Access implements Cloneable {
   ...
   * @declaredat extendj/java4/frontend/PrettyPrint.jadd:162
   */
   ...
   * @declaredat extendj/java8/frontend/NameCheck.jrag:371
   */
   ...
   * @declaredat extendj/java4/frontend/LookupType.jrag:328
   */
...
{ return isQualified() ? qualifier().type() : hostType(); }
   ...
   * @declaredat extendj/java4/frontend/TypeHierarchyCheck.jrag:162
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect TypeHierarchyCheck
   * @declaredat extendj/java4/frontend/TypeHierarchyCheck.jrag:173
   */
  @ASTNodeAnnotation.Attribute
