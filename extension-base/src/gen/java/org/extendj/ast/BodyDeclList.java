...
/**
 * @ast node
 * @declaredat extendj/java5/grammar/Generics.ast:13
...
public class BodyDeclList extends List implements Cloneable {
  ...
  public BodyDecl localMethodSignatureCopy(MethodDecl originalMethod, MemberSubstitutor m) {
    ...
    BodyDecl localMethodSignatureCopy_MethodDecl_MemberSubstitutor_value = originalMethod.substitutedBodyDecl(m);
  ...
  public BodyDecl localFieldCopy(FieldDeclaration originalDecl, MemberSubstitutor m) {
    ...
    int num = state.boundariesCrossed;
    boolean isFinal = this.is$Final();
    BodyDecl localFieldCopy_FieldDeclaration_MemberSubstitutor_value = originalDecl.substitutedBodyDecl(m);
  ...
  @ASTNodeAnnotation.Attribute
  public ConstructorDecl constructorCopy(ConstructorDecl originalDecl, MemberSubstitutor m) {
    java.util.List _parameters = new java.util.ArrayList(2);
    _parameters.add(originalDecl);
    _parameters.add(m);
    ...
    if(constructorCopy_ConstructorDecl_MemberSubstitutor_values.containsKey(_parameters)) {
      return (ConstructorDecl)constructorCopy_ConstructorDecl_MemberSubstitutor_values.get(_parameters);
    }
    ASTNode$State state = state();
    boolean intermediate = state.INTERMEDIATE_VALUE;
    state.INTERMEDIATE_VALUE = false;
    int num = state.boundariesCrossed;
    boolean isFinal = this.is$Final();
    ConstructorDecl constructorCopy_ConstructorDecl_MemberSubstitutor_value = originalDecl.substitutedBodyDecl(m);
    ...
    if(constructorCopy_ConstructorDecl_MemberSubstitutor_value != null) {
      constructorCopy_ConstructorDecl_MemberSubstitutor_value = (ConstructorDecl) constructorCopy_ConstructorDecl_MemberSubstitutor_list.getChild(constructorCopy_ConstructorDecl_MemberSubstitutor_list.numChildren-1);
