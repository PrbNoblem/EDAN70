...
/**
 * @ast node
 * @declaredat extendj/java4/grammar/Java.ast:182
...
public class InstanceOfExpr extends Expr implements Cloneable {
   ...
   * @declaredat extendj/java4/frontend/PrettyPrint.jadd:211
   */
  ...
  /**
   * @aspect TypeCheck
   * @declaredat extendj/java4/frontend/TypeCheck.jrag:276
   */
   ...
   * @declaredat extendj/java5/frontend/Generics.jrag:447
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/SyntacticClassification.jrag:116
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:252
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:253
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:254
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:255
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:256
   * @apilevel internal
   */
