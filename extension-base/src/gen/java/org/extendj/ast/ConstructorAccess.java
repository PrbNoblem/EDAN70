...
/**
 * @ast node
 * @declaredat extendj/java4/grammar/Java.ast:20
...
public class ConstructorAccess extends Access implements Cloneable {
   ...
   * @declaredat extendj/java4/frontend/PrettyPrint.jadd:481
   */
   ...
   * @declaredat extendj/java4/frontend/ExceptionHandling.jrag:142
   */
  ...
  /**
   * @aspect ExceptionHandling
   * @declaredat extendj/java4/frontend/ExceptionHandling.jrag:330
   */
  ...
  /**
   * @aspect NameCheck
   * @declaredat extendj/java4/frontend/NameCheck.jrag:152
   */
  ...
  /**
   * @aspect Annotations
   * @declaredat extendj/java5/frontend/Annotations.jrag:431
   */
   ...
   * @attribute syn
   * @aspect NameCheck
   * @declaredat extendj/java4/frontend/NameCheck.jrag:168
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat extendj/java5/frontend/VariableArityParameters.jrag:70
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect ExceptionHandling
   * @declaredat extendj/java4/frontend/ExceptionHandling.jrag:77
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat extendj/java4/frontend/LookupConstructor.jrag:35
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect ConstructScope
   * @declaredat extendj/java4/frontend/LookupConstructor.jrag:97
   */
  @ASTNodeAnnotation.Attribute
  ...
  /**
   * @declaredat extendj/java4/frontend/LookupMethod.jrag:51
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/LookupType.jrag:118
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/LookupType.jrag:331
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/LookupVariable.jrag:219
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/SyntacticClassification.jrag:144
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/TypeHierarchyCheck.jrag:39
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/TypeHierarchyCheck.jrag:168
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/TypeHierarchyCheck.jrag:177
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:100
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:337
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:338
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:339
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:340
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:341
   * @apilevel internal
   */
