...
/**
 * @ast node
 * @declaredat extendj/java4/grammar/Java.ast:170
...
public class OrLogicalExpr extends LogicalExpr implements Cloneable {
  ...
  public boolean isDAafterTrue(Variable v) {
    ...
    boolean isDAafterTrue_Variable_value = isFalse() || (getLeftOperand().isDAafterTrue(v) && getRightOperand().isDAafterTrue(v));
  ...
  public boolean isDAafterFalse(Variable v) {
    ...
    int num = state.boundariesCrossed;
    boolean isFinal = this.is$Final();
    boolean isDAafterFalse_Variable_value = isTrue() || getRightOperand().isDAafterFalse(v);
    if (isFinal && num == state().boundariesCrossed) {
  ...
  /**
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:416
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:907
   * @apilevel internal
   */
