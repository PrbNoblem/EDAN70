 ...
 * @ast node
 * @declaredat extendj/java5/grammar/StaticImports.ast:12
...
public class SingleStaticImportDecl extends StaticImportDecl implements Cloneable {
   ...
   * @declaredat extendj/java5/frontend/PrettyPrint.jadd:385
   */
   ...
   * @declaredat extendj/java5/frontend/StaticImports.jrag:105
   */
   ...
   * @aspect StaticImports
   * @declaredat extendj/java5/frontend/StaticImports.jrag:156
   */
  ...
  /**
   * @declaredat extendj/java5/frontend/StaticImports.jrag:295
   * @apilevel internal
   */
