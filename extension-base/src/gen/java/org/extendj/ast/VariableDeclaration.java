...
/**
 * @ast node
 * @declaredat extendj/java4/grammar/Java.ast:80
...
public class VariableDeclaration extends ASTNode<ASTNode> implements Cloneable, SimpleSet, Iterator, Variable {
   ...
   * @declaredat extendj/java4/frontend/DataStructures.jrag:123
   */
  ...
  /**
   * @aspect DataStructures
   * @declaredat extendj/java4/frontend/DataStructures.jrag:127
   */
  public boolean isSingleton() { return true; }
  /**
   * @aspect DataStructures
   * @declaredat extendj/java4/frontend/DataStructures.jrag:128
   */
  public boolean isSingleton(Object o) { return contains(o); }
  /**
   * @aspect DataStructures
   * @declaredat extendj/java4/frontend/DataStructures.jrag:131
   */
  private VariableDeclaration iterElem;
  /**
   * @aspect DataStructures
   * @declaredat extendj/java4/frontend/DataStructures.jrag:132
   */
  public Iterator iterator() { iterElem = this; return this; }
  /**
   * @aspect DataStructures
   * @declaredat extendj/java4/frontend/DataStructures.jrag:133
   */
  public boolean hasNext() { return iterElem != null; }
  /**
   * @aspect DataStructures
   * @declaredat extendj/java4/frontend/DataStructures.jrag:134
   */
  public Object next() { Object o = iterElem; iterElem = null; return o; }
  /**
   * @aspect DataStructures
   * @declaredat extendj/java4/frontend/DataStructures.jrag:135
   */
  public void remove() { throw new UnsupportedOperationException(); }
  /**
   * @aspect NodeConstructors
   * @declaredat extendj/java4/frontend/NodeConstructors.jrag:85
   */
  ...
  /**
   * @aspect NodeConstructors
   * @declaredat extendj/java4/frontend/NodeConstructors.jrag:89
   */
  ...
  /**
   * @aspect TypeCheck
   * @declaredat extendj/java4/frontend/TypeCheck.jrag:43
   */
   ...
   * @declaredat extendj/java7/frontend/UncheckedConversion.jrag:41
   */
  ...
  /**
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:245
   */
   ...
   * @declaredat extendj/java8/frontend/NameCheck.jrag:139
   */
   ...
   * @declaredat extendj/java4/frontend/DeclareBeforeUse.jrag:34
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect DA
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:256
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect DU
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:780
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat extendj/java4/frontend/LookupVariable.jrag:42
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect NameCheck
   * @declaredat extendj/java4/frontend/NameCheck.jrag:365
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect NestedTypes
   * @declaredat extendj/java4/frontend/TypeAnalysis.jrag:563
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect NestedTypes
   * @declaredat extendj/java4/frontend/TypeAnalysis.jrag:640
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat extendj/java7/frontend/SuppressWarnings.jrag:35
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat extendj/java7/frontend/TryWithResources.jrag:182
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat extendj/java8/frontend/EffectivelyFinal.jrag:32
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat extendj/java8/frontend/EnclosingLambda.jrag:36
   */
  @ASTNodeAnnotation.Attribute
  ...
  /**
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:62
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:557
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:1002
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/Modifiers.jrag:327
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/SyntacticClassification.jrag:112
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/TypeAnalysis.jrag:287
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java5/frontend/Annotations.jrag:119
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java5/frontend/GenericMethodsInference.jrag:59
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:39
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:349
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:350
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:351
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:352
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:353
   * @apilevel internal
   */
