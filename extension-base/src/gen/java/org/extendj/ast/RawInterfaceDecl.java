 ...
 * @ast node
 * @declaredat /home/felix/edan70final/EDAN70/extension-base/extendj/java5/grammar/Generics.ast:26
...
public class RawInterfaceDecl extends ParInterfaceDecl implements Cloneable {
   ...
   */
  public RawInterfaceDecl(Modifiers p0, String p1, List<TypeVariable> p2, Parameterization p3, List<Access> p4, List<BodyDecl> p5) {
    setChild(p0, 0);
    setID(p1);
    setChild(p2, 1);
   ...
   */
  public RawInterfaceDecl(Modifiers p0, beaver.Symbol p1, List<TypeVariable> p2, Parameterization p3, List<Access> p4, List<BodyDecl> p5) {
    setChild(p0, 0);
    setID(p1);
    setChild(p2, 1);
    setParameterization(p3);
