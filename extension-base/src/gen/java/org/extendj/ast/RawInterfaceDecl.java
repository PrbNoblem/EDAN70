...
/**
 * @ast node
 * @declaredat extendj/java5/grammar/Generics.ast:10
...
public class RawInterfaceDecl extends ParInterfaceDecl implements Cloneable {
   ...
   * @declaredat extendj/java5/frontend/Generics.jrag:1066
   */
  ...
  /**
   * @aspect LookupParTypeDecl
   * @declaredat extendj/java5/frontend/Generics.jrag:1133
   */
  ...
  /**
   * @aspect LookupParTypeDecl
   * @declaredat extendj/java5/frontend/Generics.jrag:1161
   */
  ...
  public void setSuperInterfaceList(List<Access> node) {
    throw new Error("Can not replace NTA child SuperInterfaceList in RawInterfaceDecl!");
  }
  /**
  ...
  public void setArgumentList(List<Access> node) {
    throw new Error("Can not replace NTA child ArgumentList in RawInterfaceDecl!");
  }
  /**
  ...
  public List getArgumentList() {
    ...
    getArgumentList_value = ((GenericInterfaceDecl) genericDecl()).createArgumentList(Collections.<TypeDecl>emptyList());
