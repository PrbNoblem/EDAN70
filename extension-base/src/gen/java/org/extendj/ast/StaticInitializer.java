...
/**
 * @ast node
 * @declaredat extendj/java4/grammar/Java.ast:71
...
public class StaticInitializer extends BodyDecl implements Cloneable {
   ...
   * @declaredat extendj/java4/frontend/PrettyPrint.jadd:244
   */
  ...
  /**
   * @aspect Modifiers
   * @declaredat extendj/java4/frontend/Modifiers.jrag:217
   */
   ...
   * @declaredat extendj/java4/frontend/UnreachableStatements.jrag:40
   */
   ...
   * @declaredat extendj/java4/frontend/ExceptionHandling.jrag:80
   */
  @ASTNodeAnnotation.Attribute
  ...
  /**
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:481
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/ExceptionHandling.jrag:236
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/TypeCheck.jrag:588
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/TypeHierarchyCheck.jrag:187
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/UnreachableStatements.jrag:65
   * @apilevel internal
   */
