...
/**
 * @ast node
 * @declaredat /home/felix/EDAN70/extension-base/extendj/java4/grammar/Java.ast:107
...
public class AssignSimpleExpr extends AssignExpr implements Cloneable {
   ...
   * @declaredat /home/felix/EDAN70/extension-base/extendj/java7/frontend/SuppressWarnings.jrag:36
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="SuppressWarnings", declaredAt="/home/felix/EDAN70/extension-base/extendj/java7/frontend/SuppressWarnings.jrag:36")
  ...
  public boolean Define_isDest(ASTNode _callerNode, ASTNode _childNode) {
    if (getDestNoTransform() != null && _callerNode == getDest()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java4/frontend/DefiniteAssignment.jrag:36
      return true;
    }
    else {
  ...
  public boolean Define_isSource(ASTNode _callerNode, ASTNode _childNode) {
    if (getDestNoTransform() != null && _callerNode == getDest()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java4/frontend/DefiniteAssignment.jrag:46
      return false;
    }
    else {
  ...
  public TypeDecl Define_assignConvertedType(ASTNode _callerNode, ASTNode _childNode) {
    if (getSourceNoTransform() != null && _callerNode == getSource()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java5/frontend/GenericMethodsInference.jrag:67
      return getDest().type();
    }
    else {
  ...
  protected void collect_contributors_CompilationUnit_problems(CompilationUnit _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /home/felix/EDAN70/extension-base/extendj/java7/frontend/UncheckedConversion.jrag:51
