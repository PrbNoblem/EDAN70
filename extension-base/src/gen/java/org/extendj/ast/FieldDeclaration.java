...
/**
 * @ast node
 * @declaredat extendj/java4/grammar/Java.ast:77
...
public class FieldDeclaration extends MemberDecl implements Cloneable, SimpleSet, Iterator, Variable {
   ...
   * @declaredat extendj/java4/frontend/PrettyPrint.jadd:41
   */
  ...
  /**
   * @aspect BoundNames
   * @declaredat extendj/java4/frontend/BoundNames.jrag:32
   */
  ...
  /**
   * @aspect BoundNames
   * @declaredat extendj/java4/frontend/BoundNames.jrag:106
   */
   ...
   * @declaredat extendj/java4/frontend/DataStructures.jrag:105
   */
  ...
  /**
   * @aspect DataStructures
   * @declaredat extendj/java4/frontend/DataStructures.jrag:109
   */
  public boolean isSingleton() { return true; }
  /**
   * @aspect DataStructures
   * @declaredat extendj/java4/frontend/DataStructures.jrag:110
   */
  public boolean isSingleton(Object o) { return contains(o); }
  /**
   * @aspect DataStructures
   * @declaredat extendj/java4/frontend/DataStructures.jrag:113
   */
  private FieldDeclaration iterElem;
  /**
   * @aspect DataStructures
   * @declaredat extendj/java4/frontend/DataStructures.jrag:114
   */
  public Iterator iterator() { iterElem = this; return this; }
  /**
   * @aspect DataStructures
   * @declaredat extendj/java4/frontend/DataStructures.jrag:115
   */
  public boolean hasNext() { return iterElem != null; }
  /**
   * @aspect DataStructures
   * @declaredat extendj/java4/frontend/DataStructures.jrag:116
   */
  public Object next() { Object o = iterElem; iterElem = null; return o; }
  /**
   * @aspect DataStructures
   * @declaredat extendj/java4/frontend/DataStructures.jrag:117
   */
  public void remove() { throw new UnsupportedOperationException(); }
  /**
   * @aspect DefiniteAssignment
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:194
   */
  ...
  /**
   * @aspect Modifiers
   * @declaredat extendj/java4/frontend/Modifiers.jrag:140
   */
  ...
  /**
   * @aspect NameCheck
   * @declaredat extendj/java4/frontend/NameCheck.jrag:352
   */
   ...
   * @declaredat extendj/java4/frontend/NodeConstructors.jrag:97
   */
  ...
  /**
   * @aspect NodeConstructors
   * @declaredat extendj/java4/frontend/NodeConstructors.jrag:101
   */
  ...
  /**
   * @aspect TypeCheck
   * @declaredat extendj/java4/frontend/TypeCheck.jrag:55
   */
   ...
   * @declaredat extendj/java4/frontend/VariableDeclaration.jrag:112
   */
  private FieldDecl fieldDecl = null;
  /**
   * @aspect VariableDeclarationTransformation
   * @declaredat extendj/java4/frontend/VariableDeclaration.jrag:113
   */
  ...
  /**
   * @aspect VariableDeclarationTransformation
   * @declaredat extendj/java4/frontend/VariableDeclaration.jrag:116
   */
   ...
   * @declaredat extendj/java5/frontend/Generics.jrag:1400
   */
   ...
   * @declaredat extendj/java7/frontend/UncheckedConversion.jrag:47
   */
   ...
   * @declaredat extendj/java4/frontend/ExceptionHandling.jrag:81
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat extendj/java7/frontend/SuppressWarnings.jrag:36
   */
  @ASTNodeAnnotation.Attribute
  ...
  /**
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:61
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:361
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/ExceptionHandling.jrag:209
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/Modifiers.jrag:303
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/Modifiers.jrag:304
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/Modifiers.jrag:305
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/Modifiers.jrag:306
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/Modifiers.jrag:307
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/Modifiers.jrag:308
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/Modifiers.jrag:309
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/SyntacticClassification.jrag:105
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/TypeAnalysis.jrag:286
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/TypeHierarchyCheck.jrag:189
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java5/frontend/Annotations.jrag:107
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java5/frontend/GenericMethodsInference.jrag:60
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:40
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:373
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:374
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:375
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:376
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:377
   * @apilevel internal
   */
