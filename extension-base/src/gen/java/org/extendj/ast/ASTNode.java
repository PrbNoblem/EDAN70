...
public class ASTNode<T extends ASTNode> extends beaver.Symbol implements Cloneable, PrettyPrintable, Iterable<T> {
  /**
   * @aspect DumpTree
   * @declaredat extendj/java4/frontend/DumpTree.jadd:38
   */
  private String DUMP_TREE_INDENT = "  ";
  /**
   * @aspect DumpTree
   * @declaredat extendj/java4/frontend/DumpTree.jadd:40
   */
  ...
  /**
   * @aspect DumpTree
   * @declaredat extendj/java4/frontend/DumpTree.jadd:46
   */
  ...
  /**
   * @aspect DumpTree
   * @declaredat extendj/java4/frontend/DumpTree.jadd:51
   */
  ...
  /**
   * @aspect DumpTree
   * @declaredat extendj/java4/frontend/DumpTree.jadd:65
   */
  ...
  /**
   * @aspect DumpTree
   * @declaredat extendj/java4/frontend/DumpTree.jadd:81
   */
  ...
  /**
   * @aspect DumpTree
   * @declaredat extendj/java4/frontend/DumpTree.jadd:87
   */
  ...
  /**
   * @aspect DumpTree
   * @declaredat extendj/java4/frontend/DumpTree.jadd:92
   */
   ...
   * @declaredat extendj/java4/frontend/StructuredPrettyPrint.jadd:32
   */
   ...
   * @aspect StructuredPrettyPrint
   * @declaredat extendj/java4/frontend/StructuredPrettyPrint.jadd:43
   */
   ...
   * @declaredat extendj/java4/frontend/AccessControl.jrag:150
   */
  public void accessControl() {
  }
  /**
   * @aspect AnonymousClasses
   * @declaredat extendj/java4/frontend/AnonymousClasses.jrag:123
   */
  ...
  /**
   * @aspect BranchTarget
   * @declaredat extendj/java4/frontend/BranchTarget.jrag:90
   */
   ...
   * @declaredat extendj/java4/frontend/DeclareBeforeUse.jrag:42
   */
   ...
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:34
   */
  public void definiteAssignment() {
  }
  /**
   * @aspect DA
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:495
   */
  ...
  /**
   * @aspect DA
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:627
   */
  ...
  /**
   * @aspect ErrorCheck
   * @declaredat extendj/java4/frontend/ErrorCheck.jrag:33
   */
  ...
  /**
   * @aspect ErrorCheck
   * @declaredat extendj/java4/frontend/ErrorCheck.jrag:57
   */
  ...
  /**
   * @aspect ErrorCheck
   * @declaredat extendj/java4/frontend/ErrorCheck.jrag:63
   */
  ...
  /**
   * @aspect ErrorCheck
   * @declaredat extendj/java4/frontend/ErrorCheck.jrag:67
   */
  public int start() {
    return start;
  }
  /**
   * @aspect ErrorCheck
   * @declaredat extendj/java4/frontend/ErrorCheck.jrag:70
   */
  ...
  /**
   * @aspect ErrorCheck
   * @declaredat extendj/java4/frontend/ErrorCheck.jrag:74
   */
  public int end() {
    return end;
  }
  /**
   * @aspect ErrorCheck
   * @declaredat extendj/java4/frontend/ErrorCheck.jrag:78
   */
  ...
  /**
   * @aspect ErrorCheck
   * @declaredat extendj/java4/frontend/ErrorCheck.jrag:81
   */
  ...
  /**
   * @aspect ErrorCheck
   * @declaredat extendj/java4/frontend/ErrorCheck.jrag:84
   */
  ...
  /**
   * @aspect ErrorCheck
   * @declaredat extendj/java4/frontend/ErrorCheck.jrag:198
   */
  ...
  /**
   * @aspect ErrorCheck
   * @declaredat extendj/java4/frontend/ErrorCheck.jrag:202
   */
  ...
  /**
   * @aspect ErrorCheck
   * @declaredat extendj/java4/frontend/ErrorCheck.jrag:221
   */
   ...
   * @declaredat extendj/java4/frontend/ExceptionHandling.jrag:87
   */
  public void exceptionHandling() {
  }
  /**
   * @aspect ExceptionHandling
   * @declaredat extendj/java4/frontend/ExceptionHandling.jrag:271
   */
  ...
  /**
   * @aspect LookupMethod
   * @declaredat extendj/java4/frontend/LookupMethod.jrag:92
   */
   ...
   * @declaredat extendj/java4/frontend/LookupMethod.jrag:511
   */
   ...
   * @declaredat extendj/java4/frontend/LookupVariable.jrag:274
   */
  ...
  /**
   * @aspect Modifiers
   * @declaredat extendj/java4/frontend/Modifiers.jrag:32
   */
  void checkModifiers() {
  }
  /**
   * @aspect NameCheck
   * @declaredat extendj/java4/frontend/NameCheck.jrag:33
   */
  public void nameCheck() {
  }
  /**
   * @aspect NameCheck
   * @declaredat extendj/java4/frontend/NameCheck.jrag:36
   */
   ...
   * @aspect NTAFinally
   * @declaredat extendj/java4/frontend/NTAFinally.jrag:35
   */
   ...
   * @declaredat extendj/java4/frontend/PrettyPrintUtil.jrag:41
   */
   ...
   * @aspect PrettyPrintUtil
   * @declaredat extendj/java4/frontend/PrettyPrintUtil.jrag:51
   */
   ...
   * @aspect PrettyPrintUtil
   * @declaredat extendj/java4/frontend/PrettyPrintUtil.jrag:58
   */
  ...
  /**
   * @aspect PrettyPrintUtil
   * @declaredat extendj/java4/frontend/PrettyPrintUtil.jrag:62
   */
  public void prettyPrint(PrettyPrinter out) {
  }
  /**
   * @aspect PrimitiveTypes
   * @declaredat extendj/java4/frontend/PrimitiveTypes.jrag:32
   */
  protected static final String PRIMITIVE_PACKAGE_NAME = "@primitive";
  /**
   * @aspect TypeCheck
   * @declaredat extendj/java4/frontend/TypeCheck.jrag:33
   */
  public void typeCheck() {
  }
  /**
   * @aspect UnreachableStatements
   * @declaredat extendj/java4/frontend/UnreachableStatements.jrag:33
   */
  void checkUnreachableStmt() {
  }
  /**
   * @aspect VariableDeclarationTransformation
   * @declaredat extendj/java4/frontend/VariableDeclaration.jrag:154
   */
  ...
  /**
   * @aspect Enums
   * @declaredat extendj/java5/frontend/Enums.jrag:159
   */
  ...
  /**
   * @aspect Enums
   * @declaredat extendj/java5/frontend/Enums.jrag:490
   */
   ...
   * declarations.
   * @aspect Warnings
   * @declaredat extendj/java7/frontend/Warnings.jadd:60
   */
  public void checkWarnings() {
	}
  /**
   * @aspect UncheckedConversion
   * @declaredat extendj/java7/frontend/UncheckedConversion.jrag:65
   */
   ...
   * unchecked warnings.
   * @aspect Warnings
   * @declaredat extendj/java7/frontend/Warnings.jadd:42
   */
   ...
   */
    ...
    for(int i = 0; i < getNumChild(); i++) {
      getChild(i).collect_contributors_CompilationUnit_usedTypes();
    }
  }
   ...
   * @attribute syn
   * @aspect ErrorCheck
   * @declaredat extendj/java4/frontend/ErrorCheck.jrag:45
   */
   ...
   * @declaredat extendj/java5/frontend/Generics.jrag:1240
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat extendj/java4/frontend/Options.jadd:39
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect ClassPath
   * @declaredat extendj/java4/frontend/ClassPath.jrag:79
   */
  @ASTNodeAnnotation.Attribute
