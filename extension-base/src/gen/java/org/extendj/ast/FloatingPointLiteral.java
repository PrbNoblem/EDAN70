 ...
 * @ast node
 * @declaredat extendj/java7/grammar/Literals.ast:60
...
public class FloatingPointLiteral extends NumericLiteral implements Cloneable {
  /**
   * @aspect TypeCheck
   * @declaredat extendj/java4/frontend/TypeCheck.jrag:669
   */
   ...
   * @declaredat extendj/java7/frontend/Literals.jrag:131
   */
