...
/**
 * @ast node
 * @declaredat extendj/java8/grammar/Lambda.ast:1
...
public class LambdaExpr extends Expr implements Cloneable, VariableScope {
   ...
   * @declaredat extendj/java8/frontend/PrettyPrint.jadd:64
   */
  ...
  /**
   * @aspect TypeCheck
   * @declaredat extendj/java8/frontend/TypeCheck.jrag:115
   */
   ...
   * @declaredat extendj/java8/frontend/EnclosingLambda.jrag:38
   */
  @ASTNodeAnnotation.Attribute
  ...
  /**
   * @declaredat extendj/java8/frontend/EffectivelyFinal.jrag:34
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/EnclosingLambda.jrag:42
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/ExtraInheritedEqs.jrag:29
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/ExtraInheritedEqs.jrag:30
   * @apilevel internal
   */
      ...
      int childIndex = this.getIndexOfChild(caller);
{
  ...
  /**
   * @declaredat extendj/java8/frontend/ExtraInheritedEqs.jrag:33
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/LambdaExpr.jrag:150
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/LookupVariable.jrag:56
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/NameCheck.jrag:35
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TypeCheck.jrag:33
   * @apilevel internal
   */
