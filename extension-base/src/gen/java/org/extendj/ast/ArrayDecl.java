...
/**
 * @ast node
 * @declaredat extendj/java4/grammar/Java.ast:65
...
public class ArrayDecl extends ClassDecl implements Cloneable {
  /**
   * @aspect Arrays
   * @declaredat extendj/java4/frontend/Arrays.jrag:79
   */
   ...
   * @declaredat extendj/java5/frontend/Generics.jrag:1035
   */
  ...
  /**
   * @aspect LookupParTypeDecl
   * @declaredat extendj/java5/frontend/Generics.jrag:1088
   */
   ...
   * @declaredat extendj/java4/frontend/TypeAnalysis.jrag:143
   */
  private boolean refined_TypeConversion_ArrayDecl_castingConversionTo_TypeDecl(TypeDecl type)
{
   ...
   * @attribute inh
   * @aspect TypeConversion
   * @declaredat extendj/java4/frontend/TypeAnalysis.jrag:161
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect TypeConversion
   * @declaredat extendj/java4/frontend/TypeAnalysis.jrag:162
   */
  @ASTNodeAnnotation.Attribute
