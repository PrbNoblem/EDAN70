...
/**
 * @ast node
 * @declaredat extendj/java4/grammar/Java.ast:210
...
public class ReturnStmt extends Stmt implements Cloneable {
   ...
   * @declaredat extendj/java4/frontend/PrettyPrint.jadd:219
   */
  ...
  /**
   * @aspect BranchTarget
   * @declaredat extendj/java4/frontend/BranchTarget.jrag:104
   */
   ...
   * @declaredat extendj/java4/frontend/NodeConstructors.jrag:73
   */
  ...
  /**
   * @aspect TypeCheck
   * @declaredat extendj/java8/frontend/TypeCheck.jrag:196
   */
   ...
   * @attribute inh
   * @aspect TypeCheck
   * @declaredat extendj/java4/frontend/TypeCheck.jrag:472
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat extendj/java8/frontend/EnclosingLambda.jrag:33
   */
  @ASTNodeAnnotation.Attribute
  ...
  /**
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:734
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java4/frontend/DefiniteAssignment.jrag:1353
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java5/frontend/GenericMethodsInference.jrag:63
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:41
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:355
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:356
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:357
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:358
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:359
   * @apilevel internal
   */
   ...
   * @declaredat extendj/java8/frontend/LambdaBody.jrag:52
   */
    if ((enclosingLambda() != null) && (enclosingLambda().hostType() == hostType())) {
      {
