 ...
 * @ast node
 * @declaredat extendj/java7/grammar/MultiCatch.ast:19
...
public class CatchParameterDeclaration extends ASTNode<ASTNode> implements Cloneable, Variable, SimpleSet, Iterator {
   ...
   * @declaredat extendj/java7/frontend/PrettyPrint.jadd:39
   */
  ...
  /**
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:85
   */
  ...
  /**
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:89
   */
  public boolean isSingleton() { return true; }
  /**
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:90
   */
  public boolean isSingleton(Object o) { return contains(o); }
  /**
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:93
   */
  private CatchParameterDeclaration iterElem;
  /**
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:94
   */
  public Iterator iterator() { iterElem = this; return this; }
  /**
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:95
   */
  public boolean hasNext() { return iterElem != null; }
  /**
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:96
   */
  public Object next() { Object o = iterElem; iterElem = null; return o; }
  /**
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:97
   */
   ...
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:131
   */
   ...
   * @declaredat extendj/java8/frontend/NameCheck.jrag:71
   */
   ...
   * @attribute syn
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:64
   */
  @ASTNodeAnnotation.Attribute
  public Expr getInit() {
    ASTNode$State state = state();
   ...
   * @attribute syn
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:67
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute syn
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:175
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:36
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:44
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:45
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:46
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:71
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:167
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:182
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute inh
   * @aspect MultiCatch
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:183
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat extendj/java7/frontend/PreciseRethrow.jrag:213
   */
  @ASTNodeAnnotation.Attribute
  ...
  /**
   * @declaredat extendj/java7/frontend/MultiCatch.jrag:113
   * @apilevel internal
   */
