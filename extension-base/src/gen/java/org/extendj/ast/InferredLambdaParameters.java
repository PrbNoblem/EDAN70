...
/**
 * @ast node
 * @declaredat extendj/java8/grammar/Lambda.ast:8
...
public class InferredLambdaParameters extends LambdaParameters implements Cloneable {
   ...
   * @declaredat extendj/java8/frontend/PrettyPrint.jadd:54
   */
   ...
   * @declaredat extendj/java8/frontend/NameCheck.jrag:559
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/EffectivelyFinal.jrag:37
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/LookupVariable.jrag:35
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TypeCheck.jrag:454
   * @apilevel internal
   */
