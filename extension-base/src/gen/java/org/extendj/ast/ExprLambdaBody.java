...
/**
 * @ast node
 * @declaredat extendj/java8/grammar/Lambda.ast:13
...
public class ExprLambdaBody extends LambdaBody implements Cloneable {
   ...
   * @declaredat extendj/java8/frontend/PrettyPrint.jadd:38
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:126
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:208
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:209
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:210
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:211
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:212
   * @apilevel internal
   */
