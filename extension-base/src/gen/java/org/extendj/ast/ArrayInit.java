...
/**
 * @ast node
 * @declaredat /home/felix/EDAN70/extension-base/extendj/java4/grammar/Java.ast:92
...
public class ArrayInit extends Expr implements Cloneable {
   ...
   * @declaredat /home/felix/EDAN70/extension-base/extendj/java4/frontend/PrettyPrint.jadd:58
   */
  ...
  @ASTNodeAnnotation.Source(aspect="DefiniteAssignment", declaredAt="/home/felix/EDAN70/extension-base/extendj/java4/frontend/DefiniteAssignment.jrag:653")
  ...
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN, isCircular=true)
  @ASTNodeAnnotation.Source(aspect="DefiniteUnassignment", declaredAt="/home/felix/EDAN70/extension-base/extendj/java4/frontend/DefiniteAssignment.jrag:1199")
   ...
   * @attribute syn
   * @aspect TypeCheck
   * @declaredat /home/felix/EDAN70/extension-base/extendj/java4/frontend/TypeCheck.jrag:188
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="TypeCheck", declaredAt="/home/felix/EDAN70/extension-base/extendj/java4/frontend/TypeCheck.jrag:188")
   ...
   * @attribute inh
   * @aspect TypeAnalysis
   * @declaredat /home/felix/EDAN70/extension-base/extendj/java4/frontend/TypeAnalysis.jrag:277
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="/home/felix/EDAN70/extension-base/extendj/java4/frontend/TypeAnalysis.jrag:277")
  ...
  public boolean Define_isSource(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getInitListNoTransform()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java4/frontend/DefiniteAssignment.jrag:59
  ...
  public boolean Define_assignedBefore(ASTNode _callerNode, ASTNode _childNode, Variable v) {
    if (_callerNode == getInitListNoTransform()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java4/frontend/DefiniteAssignment.jrag:651
      int childIndex = _callerNode.getIndexOfChild(_childNode);
  ...
  public boolean Define_unassignedBefore(ASTNode _callerNode, ASTNode _childNode, Variable v) {
    if (_callerNode == getInitListNoTransform()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java4/frontend/DefiniteAssignment.jrag:1197
      int childIndex = _callerNode.getIndexOfChild(_childNode);
  ...
  public TypeDecl Define_declType(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getInitListNoTransform()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java4/frontend/TypeAnalysis.jrag:284
      int childIndex = _callerNode.getIndexOfChild(_childNode);
  ...
  public TypeDecl Define_assignConvertedType(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getInitListNoTransform()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java5/frontend/GenericMethodsInference.jrag:68
      int childIndex = _callerNode.getIndexOfChild(_childNode);
      return declType().componentType();
    }
    else {
  ...
  public TypeDecl Define_targetType(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getInitListNoTransform()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java8/frontend/TargetType.jrag:78
      int childIndex = _callerNode.getIndexOfChild(_childNode);
      {
  ...
  public boolean Define_assignmentContext(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getInitListNoTransform()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java8/frontend/TargetType.jrag:322
      int childIndex = _callerNode.getIndexOfChild(_childNode);
      return true;
    }
    else {
  ...
  public boolean Define_invocationContext(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getInitListNoTransform()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java8/frontend/TargetType.jrag:323
      int childIndex = _callerNode.getIndexOfChild(_childNode);
      return false;
    }
    else {
  ...
  public boolean Define_castContext(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getInitListNoTransform()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java8/frontend/TargetType.jrag:324
      int childIndex = _callerNode.getIndexOfChild(_childNode);
      return false;
    }
    else {
  ...
  public boolean Define_stringContext(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getInitListNoTransform()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java8/frontend/TargetType.jrag:325
      int childIndex = _callerNode.getIndexOfChild(_childNode);
      return false;
    }
    else {
  ...
  public boolean Define_numericContext(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getInitListNoTransform()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java8/frontend/TargetType.jrag:326
      int childIndex = _callerNode.getIndexOfChild(_childNode);
      return false;
    }
    else {
  ...
  protected void collect_contributors_CompilationUnit_problems(CompilationUnit _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /home/felix/EDAN70/extension-base/extendj/java4/frontend/TypeCheck.jrag:186
    {
