...
/**
 * @ast node
 * @declaredat extendj/java4/grammar/Java.ast:141
...
public class CastExpr extends Expr implements Cloneable {
   ...
   * @declaredat extendj/java4/frontend/PrettyPrint.jadd:400
   */
  ...
  /**
   * @aspect TypeCheck
   * @declaredat extendj/java4/frontend/TypeCheck.jrag:297
   */
   ...
   * @declaredat extendj/java7/frontend/UncheckedConversion.jrag:59
   */
   ...
   * @declaredat extendj/java7/frontend/SuppressWarnings.jrag:38
   */
  @ASTNodeAnnotation.Attribute
  ...
  /**
   * @declaredat extendj/java4/frontend/SyntacticClassification.jrag:115
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:42
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:307
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:308
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:309
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:310
   * @apilevel internal
   */
  ...
  /**
   * @declaredat extendj/java8/frontend/TargetType.jrag:311
   * @apilevel internal
   */
