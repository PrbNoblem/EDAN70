...
/**
 * @ast node
 * @declaredat extendj/java5/grammar/Annotations.ast:2
...
public class AnnotationDecl extends InterfaceDecl implements Cloneable {
   ...
   * @declaredat extendj/java5/frontend/PrettyPrint.jadd:292
   */
  ...
  /**
   * @aspect Annotations
   * @declaredat extendj/java5/frontend/Annotations.jrag:130
   */
    ...
    for (int i = 0; i < getNumBodyDecl(); i++) {
      if (getBodyDecl(i) instanceof MethodDecl) {
        ...
        if (m.annotationMethodOverride()) {
          m.errorf("annotation method overrides %s", m.signature());
        }
      }
    }
  ...
  /**
   * @declaredat extendj/java5/frontend/Annotations.jrag:104
   * @apilevel internal
   */
