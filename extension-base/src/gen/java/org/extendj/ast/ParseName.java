...
/**
 * @ast node
 * @declaredat extendj/java4/grammar/Java.ast:32
...
public class ParseName extends Access implements Cloneable {
   ...
   * @declaredat extendj/java4/frontend/PrettyPrint.jadd:475
   */
   ...
   * @aspect PrettyPrint
   * @declaredat extendj/java7/frontend/PrettyPrint.jrag:36
   */
  ...
  public ASTNode rewriteTo() {
    // Declared at @declaredat extendj/java4/frontend/ResolveAmbiguousNames.jrag:204
  ...
  /**
   * @declaredat @declaredat extendj/java4/frontend/ResolveAmbiguousNames.jrag:204
   * @apilevel internal
   */
