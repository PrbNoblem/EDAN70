...
/**
 * @ast node
 * @declaredat /home/felix/EDAN70/extension-base/extendj/java4/grammar/Java.ast:135
...
public abstract class Unary extends Expr implements Cloneable {
   ...
   * @declaredat /home/felix/EDAN70/extension-base/extendj/java4/frontend/PrettyPrint.jadd:621
   */
   ...
   * @declaredat /home/felix/EDAN70/extension-base/extendj/java4/frontend/PrettyPrintUtil.jrag:278
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="PrettyPrintUtil", declaredAt="/home/felix/EDAN70/extension-base/extendj/java4/frontend/PrettyPrintUtil.jrag:278")
   ...
   * @attribute syn
   * @aspect PrettyPrintUtil
   * @declaredat /home/felix/EDAN70/extension-base/extendj/java4/frontend/PrettyPrintUtil.jrag:282
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="PrettyPrintUtil", declaredAt="/home/felix/EDAN70/extension-base/extendj/java4/frontend/PrettyPrintUtil.jrag:282")
  ...
  public boolean Define_assignmentContext(ASTNode _callerNode, ASTNode _childNode) {
    if (getOperandNoTransform() != null && _callerNode == getOperand()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java8/frontend/TargetType.jrag:245
      return false;
    }
    else {
  ...
  public boolean Define_invocationContext(ASTNode _callerNode, ASTNode _childNode) {
    if (getOperandNoTransform() != null && _callerNode == getOperand()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java8/frontend/TargetType.jrag:246
      return false;
    }
    else {
  ...
  public boolean Define_castContext(ASTNode _callerNode, ASTNode _childNode) {
    if (getOperandNoTransform() != null && _callerNode == getOperand()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java8/frontend/TargetType.jrag:247
      return false;
    }
    else {
  ...
  public boolean Define_stringContext(ASTNode _callerNode, ASTNode _childNode) {
    if (getOperandNoTransform() != null && _callerNode == getOperand()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java8/frontend/TargetType.jrag:248
      return false;
    }
    else {
  ...
  public boolean Define_numericContext(ASTNode _callerNode, ASTNode _childNode) {
    if (getOperandNoTransform() != null && _callerNode == getOperand()) {
      // @declaredat /home/felix/EDAN70/extension-base/extendj/java8/frontend/TargetType.jrag:249
      return false;
    }
    else {
